...
const Header = () => {
    ...
    return (
        <div className='fixed z-10 w-screen bg-primary p-6 px-16'>
            {/* desktop and tablet */}
                ...
                <div className='flex items-center gap-8'>
                    ...
                    <div className='relative flex items-center justify-center'>
                        ...
                        <div className="absolute -top-3 -right-3 w-5 h-5 rounded-full bg-cartNumBg flex items-center justify-center">
                            <p className="text-xs text-white font-semibold"> 15 </p>
                        </div>
                    </div>
                    <div className='relation'>
                        <motion.img
                            whileTap={{ scale: 0.7 }}
                            className='w-10 min-w-[40px] -mt-2 h-10 min-h-[40px] drop-shadow-2xl rounded-full cursor-pointer '
                    ...
                    {isMenu && (
                        <motion.div
                            ...
                            className='w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-16 right-16'>
                            <Link to={'createItem'}>
            ...
            {/*Mobile */}
            <div className='flex md:hidden w-full h-full bg-primary p-4'>
